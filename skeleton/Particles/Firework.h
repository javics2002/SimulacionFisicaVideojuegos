...
enum FireworkType { BROCADE, CHRYSANTHEMUM, COMET, DELAY_CRACKLE, GORDO, FOUNTAIN_FIREWORK, COLLISION };
...
public:
	Firework(ParticleSystem* sys, FireworkType t, PxVec3 spawnPos = PxVec3(0));
	Firework(Firework* f);
	~Firework() noexcept;
};